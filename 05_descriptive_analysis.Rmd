...
Demographics table - Option A
```{r}
ukbbdat$pop_cat <- factor(ukbbdat$pop_cat, levels = c(5, 6, 7, 8), labels = c("Urban", "Town and Fringe", "Village", "Hamlet and Isolated Dwelling"))
...
ICC AD & PRS by Population Category 
```{r}

```

Clustering of other environmental variables within popcat?
```{r}
